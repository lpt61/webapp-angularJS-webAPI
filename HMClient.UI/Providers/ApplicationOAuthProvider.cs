...
namespace HMClient.UI.Providers
{
    //plugs into the OWIN middleware, and processes events raised by the middleware.
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        //OAuth calls this when the app wants to get a token
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            //this's the default code, but it returns null. WHY? 
            //using Microsoft.AspNet.Identity.Owin;
